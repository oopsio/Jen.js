export class Pipeline {
    ...
    static resolveMiddleware(mw) {
        if (typeof mw === 'function') {
            ...
            if ('prototype' in mw && mw.prototype && typeof mw.prototype.handle === 'function') {
                try {
        ...
        throw new TypeError('Middleware must be a function, a class constructor, or an object with a handle() method');
    }
}

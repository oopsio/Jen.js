      ...
      return new Promise(function(resolve, reject) {
        ...
        xhr.onload = function() {
          ...
          resolve({
            ...
            json: function() { return Promise.resolve(responseJson); },
            blob: function() { 
              return Promise.resolve(new Blob([responseText], { type: contentType }));
            }
          });
        };
  ...
  if (!Array.prototype.includes) {
    Object.defineProperty(Array.prototype, 'includes', {
      value: function(searchElement, fromIndex) {
        ...
        while (k < len) {
          var elementK = O[k];
          if (elementK === searchLen || (elementK !== elementK && searchLen !== searchLen)) {
            return true;
          }
          k++;
        }

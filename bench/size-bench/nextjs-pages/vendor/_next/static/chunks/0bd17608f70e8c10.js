(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
      ...
      for (
        ...
        if (0 === a) iB && !r && us(e, t, 0, !1);
          ...
          e: {
            ...
            uu(r, n, iJ, i3, iZ, t, iQ, iq, iY, i$, l, null, -0, 0);
          }
        }
        break;
      }
    ...
    function uj(e, t) {
      (0 === t && (t = eP()), null !== (e = n4(e, t)) && (eR(e, t), uW(e)));
    }
    function uI(e) {
      var t = e.memoizedState,
        n = 0;
    ...
    var cI = o.version;
    if ("19.2.3" !== cI) throw Error(u(527, cI, "19.2.3"));
    if (
  ...
  (e, t, n) => {
    ...
    let r = e.r(638)._(e.r(2116)).default.createContext(null);
  },
  230,
  (e, t, n) => {
    "use strict";
    ...
    (() => {
      ...
      "u" > typeof __nccwpck_require__ &&
        (__nccwpck_require__.ab =
          "/ROOT/Jen.js/bench/size-bench/nextjs-pages/node_modules/next/dist/compiled/path-to-regexp/");
      var e = {};
      ((() => {
        function t(e, t) {
          void 0 === t && (t = {});
        ...
        return function e(t, n) {
          ...
          for (let c of i) {
            ...
            if (i) {
              ...
              if ((s.push(i), i.interceptionMarker)) {
                let l = t.split(i.interceptionMarker);
                if (2 !== l.length)
                  throw Object.defineProperty(
                ...
                ((a = n ? e(l[0], !0) : e(l[0], !1)),
                  (o = n ? e(l[1], !0) : e(l[1], !1)),
                  (r = i.interceptionMarker));
              }
            }
          }
          let c = s.filter((e) => "dynamic" === e.type);
          return {
            normalized: n,
            pathname: t,
            segments: s,
  ...
  (e, t, n) => {
    ...
    class Y {
      ...
      async change(e, t, n, r, a) {
        ...
        (this._inFlightRoute &&
          this.clc &&
          (O || Y.events.emit("routeChangeError", z(), this._inFlightRoute, j),
          this.clc(),
          (this.clc = null)),
          (n = (0, w.addBasePath)(
            (0, E.addLocale)(
        ...
        if (!f && this.onlyAHashChange(I) && !D) {
          ((p.asPath = I),
            Y.events.emit("hashChangeStart", n, j),
          ...
          try {
            ...
            throw (
              (0, c.default)(e) &&
                e.cancelled &&
                Y.events.emit("routeChangeError", e, I, j),
              e
            );
          }
          return (Y.events.emit("hashChangeComplete", n, j), !0);
        }
        let U = (0, g.parseRelativeUrl)(t),
          { pathname: H, query: X } = U;
        try {
        ...
        let V = n;
        H = H ? (0, i.removeTrailingSlash)((0, P.removeBasePath)(H)) : H;
        let q = (0, i.removeTrailingSlash)(H),
        ...
        let K = !!(
            ...
            (!(0, m.isDynamicRoute)(q) ||
              !(0, y.getRouteMatcher)((0, b.getRouteRegex)(q))(Q))
          ),
          J =
            !r.shallow &&
        ...
        f || Y.events.emit("routeChangeStart", n, j);
        ...
        try {
          ...
          if (
            (Y.events.emit("beforeHistoryChange", n, j),
            ...
            if (o.error)
              throw (
                f || Y.events.emit("routeChangeError", o.error, I, j),
                o.error
              );
            (f || Y.events.emit("routeChangeComplete", n, j),
      ...
      async handleRouteInfoError(e, t, n, r, a, l) {
        ...
        if ((0, u.isAssetError)(e) || l)
          throw (
            Y.events.emit("routeChangeError", e, r, a),
            G({ url: r, router: this }),
            z()
          );
        console.error(e);
...
${e.stack}`
  ...
  (e, t, n) => {
    ...
    async function X(t = {}) {
      ...
      if (
        ...
        let { initScriptLoader: t } = e.r(6992);
        t(a.scriptLoader);
      }
          ...
          .then(({ page: r, styleSheets: a }) =>
            s?.Component === r
              ? e
                  .A(9453)
                  .then((r) =>
                    e.A(3199).then((e) => ((t.App = n = e.default), r)),
                  )
  ...
  (e, t, n) => {
    "use strict";
    (Object.defineProperty(n, "__esModule", { value: !0 }), e.r(7507));
    let r = e.r(6402),
      a = e.r(5795);
    ((window.next = {
      version: r.version,

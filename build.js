...
await esbuild.build({
  entryPoints: [
    ...
    join(__dirname, 'src/core/middleware-hooks.ts'),
    join(__dirname, 'src/runtime/render.ts'),
    join(__dirname, 'src/runtime/islands.ts'),
    join(__dirname, 'src/runtime/island-hydration-client.ts'),
    join(__dirname, 'src/server/api-routes.ts'),

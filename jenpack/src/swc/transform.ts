...
export async function transformFile(
  ...
  const isJSX = options.filename.endsWith('.jsx') || options.filename.endsWith('.tsx');
...
export async function parseFile(source: string, filename: string): Promise<any> {
...
export function extractImports(ast: any): Array<{ source: string; name?: string; type: 'import' | 'export' }> {
  const imports: Array<{ source: string; name?: string; type: 'import' | 'export' }> = [];

 ...
 * ```
 */
export function Link({ href, replace = false, scroll = true, prefetch = true, children, onClick, onMouseEnter, onTouchStart, ...props }) {
    ...
    return (_jsx("a", { ref: linkRef, href: href, onClick: handleClick, onMouseEnter: handleMouseEnter, onTouchStart: handleTouchStart, ...props, children: children }));
}
export default Link;

...
if (Symbol.dispose)
  RouteMatcher.prototype[Symbol.dispose] = RouteMatcher.prototype.free;
...
const RouteMatcherFinalization =
  typeof FinalizationRegistry === 'undefined'
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_routematcher_free(ptr >>> 0, 1),
      );

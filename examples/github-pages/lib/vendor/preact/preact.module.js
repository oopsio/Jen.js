...
function A(n, l, u, t, i) {
    ...
    if (a)
        for (r = 0; r < s; r++) null != (e = u[r]) && 0 == (2 & e.__u) && (e.__e == t && (t = S(e)), E(e, e));
    return t
}
...
function F(n, l, u, t, i) {
    ...
    n: if ("style" == l)
        if ("string" == typeof u) n.style.cssText = u;
            ...
            if (u)
                for (l in u) t && u[l] == t[l] || j(n.style, l, u[l])
        }
...
function B(u, t, i, r, o, e, f, c, s) {
    ...
    if (null == x) b === k || c && u.data == k || (u.data = k);
        ...
        else if (v && (u.innerHTML = ""), P("template" == t.type ? u.content : u, d(y) ? y : [y], t, i, r, "foreignObject" == x ? "http://www.w3.org/1999/xhtml" : o, e, f, e ? e[0] : i.__k && S(i, 0), c, s), null != e)
...
function E(n, u, t) {
    ...
    if (i = n.__k)
        for (r = 0; r < i.length; r++) i[r] && E(i[r], u, t || "function" != typeof n.type);
...
export {
    x as Component, k as Fragment, Q as cloneElement, R as createContext, _ as createElement, b as createRef, _ as h, K as hydrate, t as isValidElement, l as options, J as render, L as toChildArray
};

...
export function Seo({
  ...
  return _jsxs(_Fragment, {
    children: [
      ...
      canonical && _jsx("link", { rel: "canonical", href: canonical }),
      ogTitle && _jsx("meta", { property: "og:title", content: ogTitle }),
      ogDescription &&
        _jsx("meta", { property: "og:description", content: ogDescription }),
      ogImage && _jsx("meta", { property: "og:image", content: ogImage }),

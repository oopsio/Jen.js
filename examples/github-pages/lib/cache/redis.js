...
export class RedisCache {
    ...
    async connect() {
        try {
            ...
            log.error(`Redis connection failed: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async set(key, value, ttlSec) {
        try {
            ...
            log.error(`Redis set failed for ${key}: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async get(key) {
        try {
            ...
            log.error(`Redis get failed for ${key}: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async delete(key) {
        try {
            ...
            log.error(`Redis delete failed for ${key}: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async exists(key) {
        try {
            ...
            log.error(`Redis exists check failed for ${key}: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async flush() {
        try {
            ...
            log.error(`Redis flush failed: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
    /**
    ...
    async disconnect() {
        try {
            ...
            log.error(`Redis disconnect failed: ${error instanceof Error ? error.message : String(error)}`);
            throw error;
        }
    }
}

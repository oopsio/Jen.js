    ...
    h("section", { class: "demo-section" }, [
      ...
      h("ul", null, [
        h(
          "li",
          null,
          "Checkmark Vue 3 SFC support (<template>, <script setup>, <style scoped>)",
        ),
        h("li", null, "Checkmark Svelte 4 component support (TypeScript, reactive)"),
        h("li", null, "Checkmark esbuild integration for fast compilation"),
        h("li", null, "Checkmark HMR support for dev server"),
        h("li", null, "Checkmark CSS/SCSS compilation"),
        h("li", null, "Checkmark Production bundling"),
        h("li", null, "Checkmark Runtime import with jen.import()"),
      ]),
    ]),

...
export function vueEsbuildPlugin() {
...
export function svelteEsbuildPlugin() {
...
export function invalidateVueCache(filePath) {
    vueCache.delete(filePath);
}
export function invalidateSvelteCache(filePath) {

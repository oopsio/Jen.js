...
function L(e, t, _) {
  var r,
    ...
    s = {};
  for (o in t)
    o == "key" ? (r = t[o]) : o == "ref" ? (l = t[o]) : (s[o] = t[o]);
  if (
    (arguments.length > 2 &&
      (s.children = arguments.length > 3 ? H.call(arguments, 2) : _),
    typeof e == "function" && e.defaultProps != null)
  )
    for (o in e.defaultProps) s[o] === void 0 && (s[o] = e.defaultProps[o]);
  return R(e, s, r, l, null);
}
function R(e, t, _, r, l) {
  var o = {
    type: e,
    props: t,
    key: _,
...
function K(e) {
  ((!e.__d && (e.__d = !0) && P.push(e) && !F.__r++) ||
    Z != v.debounceRendering) &&
    ((Z = v.debounceRendering) || oe)(F);
}
function F() {
  for (var e, t, _, r, l, o, s, a = 1; P.length; )
    (P.length > a && P.sort(re),
      (e = P.shift()),
      (a = P.length),
      e.__d &&
        ((_ = void 0),
...
function ae(e, t, _, r, l, o, s, a, u, i, f) {
  var n,
    p,
    c,
    m,
    ...
    h = (r && r.__k) || se,
    w = t.length;
  for (u = ke(_, t, h, u, w), n = 0; n < w; n++)
    (c = _.__k[n]) != null &&
      ((p = c.__i == -1 ? N : h[c.__i] || N),
      (c.__i = n),
      (y = G(e, c, p, l, o, s, a, u, i, f)),
      (m = c.__e),
      c.ref &&
        p.ref != c.ref &&
        (p.ref && Q(p.ref, null, c), f.push(c.ref, c.__c || m, c)),
      g == null && m != null && (g = m),
      (d = !!(4 & c.__u)) || p.__k === c.__k
        ? (u = ce(c, u, e, d))
        : typeof c.type == "function" && y !== void 0
          ? (u = y)
          : m && (u = m.nextSibling),
      (c.__u &= -7));
  return ((_.__e = g), u);
}
function ke(e, t, _, r, l) {
  var o,
    s,
    a,
    u,
    ...
    (s = t[o]) != null && typeof s != "boolean" && typeof s != "function"
      ? (typeof s == "string" ||
        ...
        s.constructor == String
          ? (s = e.__k[o] = R(null, s, null, null, null))
          : W(s)
            ? (s = e.__k[o] = R(j, { children: s }, null, null, null))
            : s.constructor === void 0 && s.__b > 0
              ? (s = e.__k[o] =
                  R(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v))
              : (e.__k[o] = s),
        (u = o + p),
        (s.__ = e),
        (s.__b = e.__b + 1),
        (a = null),
        (i = s.__i = we(s, _, u, n)) != -1 && (n--, (a = _[i]) && (a.__u |= 2)),
        a == null || a.__v == null
          ? (i == -1 && (l > f ? p-- : l < f && p++),
...
function ce(e, t, _, r) {
  ...
  if (typeof e.type == "function") {
    for (l = e.__k, o = 0; l && o < l.length; o++)
      l[o] && ((l[o].__ = e), (t = ce(l[o], t, _, r)));
    return t;
  }
  e.__e != t &&
    (r &&
      (t && e.type && !t.parentNode && (t = C(e)),
...
function we(e, t, _, r) {
  var l,
    ...
    i = t[_],
    f = i != null && (2 & i.__u) == 0;
  if ((i === null && a == null) || (f && a == i.key && u == i.type)) return _;
  if (r > (f ? 1 : 0)) {
    for (l = _ - 1, o = _ + 1; l >= 0 || o < t.length; )
      if (
        (i = t[(s = l >= 0 ? l-- : o++)]) != null &&
        !(2 & i.__u) &&
        a == i.key &&
...
function D(e, t, _, r, l) {
  var o, s;
  e: if (t == "style")
    if (typeof _ == "string") e.style.cssText = _;
    else {
      if ((typeof r == "string" && (e.style.cssText = r = ""), r))
        for (t in r) (_ && t in _) || ee(e.style, t, "");
      if (_) for (t in _) (r && _[t] == r[t]) || ee(e.style, t, _[t]);
    }
  else if (t[0] == "o" && t[1] == "n")
    ((o = t != (t = t.replace(le, "$1"))),
      (s = t.toLowerCase()),
      (t =
      ...
      _
        ? r
          ? (_.u = r.u)
          : ((_.u = z), e.addEventListener(t, o ? V : O, o))
        : e.removeEventListener(t, o ? V : O, o));
  else {
...
function G(e, t, _, r, l, o, s, a, u, i) {
  var f,
    n,
    p,
    c,
  ...
  (128 & _.__u && ((u = !!(32 & _.__u)), (o = [(a = t.__e = _.__e)])),
    (f = v.__b) && f(t));
    ...
    try {
      if (
        ...
        h &&
          ...
          k(n.__s, b.getDerivedStateFromProps(d, n.__s))),
        (c = n.props),
        (m = n.state),
        (n.__v = t),
        p)
        ...
        if (
          (h &&
            ...
            n.componentWillReceiveProps(d, S),
          t.__v == _.__v ||
            (!n.__e &&
              n.shouldComponentUpdate != null &&
              n.shouldComponentUpdate(d, n.__s, S) === !1))
        ) {
          for (
            t.__v != _.__v && ((n.props = d), (n.state = n.__s), (n.__d = !1)),
              t.__e = _.__e,
              t.__k = _.__k,
        ...
        (n.componentWillUpdate != null && n.componentWillUpdate(d, n.__s, S),
          h &&
      ...
      ((n.state = n.__s),
        ...
        h &&
          ...
          (g = n.getSnapshotBeforeUpdate(c, m)),
        (T = f),
        f != null &&
          f.type === j &&
          f.key == null &&
          (T = fe(f.props.children)),
        (a = ae(e, W(T) ? T : [T], t, _, r, l, o, s, a, u, i)),
        (n.base = t.__e),
        (t.__u &= -161),
      ...
      if (((t.__v = null), u || o != null))
        if (E.then) {
          ...
          for (I = o.length; I--; ) J(o[I]);
          B(t);
        }
      else ((t.__e = _.__e), (t.__k = _.__k), E.then || B(t));
      v.__e(E, t, _);
    }
  else
    o == null && t.__v == _.__v
      ? ((t.__k = _.__k), (t.__e = _.__e))
      : (a = t.__e = Se(_.__e, t, _, r, l, o, s, u, i));
  return ((f = v.diffed) && f(t), 128 & t.__u ? void 0 : a);
}
function B(e) {
  (e && e.__c && (e.__c.__e = !0), e && e.__k && e.__k.forEach(B));
}
function ue(e, t, _) {
  for (var r = 0; r < _.length; r++) Q(_[r], _[++r], _[++r]);
  (v.__c && v.__c(t, e),
    e.some(function (l) {
      try {
        ((e = l.__h),
...
function Se(e, t, _, r, l, o, s, a, u) {
  ...
  if (e == null) {
    ...
    ((e = document.createElementNS(l, h, d.is && d)),
      a && (v.__m && v.__m(t, o), (a = !1)),
      (o = null));
  }
  if (h == null) y === d || (a && e.data == d) || (e.data = d);
  else {
    if (((o = o && H.call(e.childNodes)), !a && o != null))
      for (y = {}, i = 0; i < e.attributes.length; i++)
        y[(c = e.attributes[i]).name] = c.value;
    for (i in y)
      if (((c = y[i]), i != "children")) {
        if (i == "dangerouslySetInnerHTML") n = c;
        else if (!(i in d)) {
          if (
            (i == "value" && "defaultValue" in d) ||
            (i == "checked" && "defaultChecked" in d)
          )
            continue;
          D(e, i, null, c, l);
        }
    ...
    if (f)
      (a ||
        (n && (f.__html == n.__html || f.__html == e.innerHTML)) ||
...
function pe(e, t, _) {
  ...
  if ((r = e.__k))
    for (l = 0; l < r.length; l++)
      r[l] && pe(r[l], t, _ || typeof e.type != "function");
  (_ || J(e.__e), (e.__c = e.__ = e.__e = void 0));
}
function Pe(e, t, _) {
...
function q(e, t, _) {
  ...
  (t == document && (t = document.documentElement),
    ...
    G(
      t,
      (e = ((!r && _) || t).__k = L(j, null, [e])),
      l || N,
      N,
      t.namespaceURI,
      !r && _ ? [_] : l ? null : t.firstChild ? H.call(t.childNodes) : null,
      o,
...
((H = se.slice),
  ...
  ($.prototype.setState = function (e, t) {
    ...
    ((_ =
      ...
      e && k(_, e),
      e != null && this.__v && (t && this._sb.push(t), K(this)));
  }),
  ...
  (O = te(!1)),
  (V = te(!0)));
const de = ({ value: e, name: t, hydrate: _ = !0 }) =>
  e
    ? L(_ ? "astro-slot" : "astro-static-slot", {
        name: t,
        dangerouslySetInnerHTML: { __html: e },
      })
    : null;
de.shouldComponentUpdate = () => !1;
var _e = de;
const x = new Map();
var Ee =
  (e) =>
  async (t, _, { default: r, ...l }, { client: o }) => {
    if (!e.hasAttribute("ssr")) return;
    for (const [u, i] of Object.entries(l)) _[u] = L(_e, { value: i, name: u });
    if (e.dataset.preactSignals) {
      const { signal: u } = await ye(async () => {
        const { signal: f } = await import("./signals.module.Cgnl4IFp.js");
        return { signal: f };
      }, []);
      ...
      for (const [f, n] of Object.entries(i))
        if (Array.isArray(n))
          n.forEach(([p, c]) => {
            const m = _[f][c];
            let g = m;
            if ((typeof c != "string" && ((g = m[0]), (c = m[1])), !x.has(p))) {
              const y = u(g);
              x.set(p, y);
            }
            _[f][c] = x.get(p);
    ...
    ((o !== "only" ? he : q)(L(t, _, r != null ? L(_e, { value: r }) : r), e),
      e.addEventListener("astro:unmount", () => q(null, e), { once: !0 }));
  };
export { Ee as c, v as l, ge as t, $ as x };

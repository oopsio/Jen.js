  ...
  return (
    <div style={{ maxWidth: "900px", margin: "0 auto", padding: "2rem" }}>
      <header style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "#666" }}>Quick reference for Jen.js framework features</p>
      </header>

      <nav style={{ marginBottom: "2rem" }}>
        <h2>Quick Links</h2>
        <ul style={{ columnCount: 2, columnGap: "2rem", lineHeight: "1.8" }}>
          <li><a href="#islands" style={{ color: "#2563eb", textDecoration: "underline" }}>Islands</a></li>
          <li><a href="#middleware" style={{ color: "#2563eb", textDecoration: "underline" }}>Middleware</a></li>
          <li><a href="#api-routes" style={{ color: "#2563eb", textDecoration: "underline" }}>API Routes</a></li>
          <li><a href="#zero-js" style={{ color: "#2563eb", textDecoration: "underline" }}>Zero-JS</a></li>
        </ul>
      </nav>
      ...
      <section id="islands" style={{ marginBottom: "3rem" }}>
        ...
        <p>
          Islands allow you to add interactivity to specific components while keeping the rest
          of the page as static HTML.
        </p>
...
export default function Page() {
  return <Counter initial={5} />;
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", marginBottom: "1rem" }}>
          ...
          <tbody>
            <tr style={{ borderBottom: "1px solid #eee" }}>
              <td style={{ padding: "0.5rem" }}><code style={{ background: "#f5f5f5" }}>load</code></td>
              <td style={{ padding: "0.5rem" }}>Immediately</td>
              <td style={{ padding: "0.5rem" }}>Critical UI</td>
            </tr>
            <tr style={{ borderBottom: "1px solid #eee" }}>
              <td style={{ padding: "0.5rem" }}><code style={{ background: "#f5f5f5" }}>idle</code></td>
              <td style={{ padding: "0.5rem" }}>Browser idle</td>
              <td style={{ padding: "0.5rem" }}>Non-critical</td>
            </tr>
            <tr>
              <td style={{ padding: "0.5rem" }}><code style={{ background: "#f5f5f5" }}>visible</code></td>
      ...
      <section id="middleware" style={{ marginBottom: "3rem" }}>
        ...
        <p>
          Middleware runs before rendering a route. Use it for authentication, authorization,
...
export default function Page({ data }) {
  return <h1>Welcome {data.user.name}</h1>;
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li><code style={{ background: "#f5f5f5" }}>ctx.redirect(url)</code> - Redirect user</li>
          <li><code style={{ background: "#f5f5f5" }}>ctx.json(data)</code> - Return JSON</li>
          <li><code style={{ background: "#f5f5f5" }}>ctx.setHeader(key, value)</code> - Set header</li>
          <li><code style={{ background: "#f5f5f5" }}>ctx.data</code> - Attach data for loader</li>
        </ul>
      </section>
      ...
      <section id="api-routes" style={{ marginBottom: "3rem" }}>
        <h2>API Routes</h2>
        <p>
          Create REST endpoints colocated with your routes. Export HTTP method handlers
          from a TypeScript file in your api/ directory.
        </p>
...
export const DELETE = async (ctx) => {
  ...
  return { deleted: true };
        ...
        <ul style={{ lineHeight: "1.8" }}>
          <li><code style={{ background: "#f5f5f5" }}>GET</code>, <code style={{ background: "#f5f5f5" }}>POST</code>, <code style={{ background: "#f5f5f5" }}>PUT</code>, <code style={{ background: "#f5f5f5" }}>PATCH</code>, <code style={{ background: "#f5f5f5" }}>DELETE</code>, <code style={{ background: "#f5f5f5" }}>HEAD</code>, <code style={{ background: "#f5f5f5" }}>OPTIONS</code></li>
        </ul>
      </section>
  ...
  return <h1>Pure HTML Page</h1>;
      ...
      <section style={{ marginBottom: "2rem" }}>
        ...
        <ol style={{ lineHeight: "1.8" }}>
          <li><strong>Use Islands for critical UI only</strong> - Keep JS minimal</li>
          <li><strong>Prefer "idle" and "visible" strategies</strong> - Defer non-critical JS</li>
          <li><strong>Use Zero-JS for static content</strong> - Blogs, docs, landing pages</li>
          <li><strong>Keep middleware lightweight</strong> - Cache expensive operations</li>
          <li><strong>Use API routes for backend logic</strong> - Keep routes pure</li>
        </ol>
      </section>

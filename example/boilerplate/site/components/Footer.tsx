        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              A modern TypeScript framework for building fast, scalable web applications.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">Changelog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">Careers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">Privacy</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">Terms</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">License</a></li>
              <li><a href="#" className="text-sm text-gray-600 hover:text-primary-600">Security</a></li>
            </ul>
          </div>
        </div>
